 ...
 * ------------------------------------------------------------------------------------------------
 * $Id: ConfigurableServerConnectionProvider.java,v 1.1 2012/02/17 11:58:58 bleujin Exp $
 * ------------------------------------------------------------------------------------------------
 *
 */
 ...
 * @see <script>links('$HeadURL: https://jminix.googlecode.com/svn/tags/jminix-1.0.0/src/main/java/org/jminix/server/ConfigurableServerConnectionProvider.java $');</script>
 */
