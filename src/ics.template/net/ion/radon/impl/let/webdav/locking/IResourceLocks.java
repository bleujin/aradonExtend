...
public interface IResourceLocks {
	 ...
	 *            who wants to unlock
	 */
	void unlockReadLockedObjects(ITransaction transaction, String path, String owner);
	 ...
	 */
	LockedObject getWriteLockedObjectByID(ITransaction transaction, String id);
	 ...
	 * @return LockedObject or null if no LockedObject on specified path exists
	 */
	LockedObject getWriteLockedObjectByPath(ITransaction transaction, String path);
	 ...
	 * @return LockedObject or null if no LockedObject on specified path exists
	 */
	LockedObject getReadLockedObjectByID(ITransaction transaction, String id);
	 ...
	 * @return LockedObject or null if no LockedObject on specified path exists
	 */
	LockedObject getReadLockedObjectByPath(ITransaction transaction, String path);
