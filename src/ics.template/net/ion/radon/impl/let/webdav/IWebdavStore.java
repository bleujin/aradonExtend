/*
 * $Header: /home/cvs/cvsroot/AradonExtend/src/ics.template/net/ion/radon/impl/let/webdav/IWebdavStore.java,v 1.1 2012/03/13 06:09:30 bleujin Exp $
 * $Revision: 1.1 $
 * $Date: 2012/03/13 06:09:30 $
 *
 * ====================================================================
 *
...
import net.ion.radon.impl.let.webdav.back.StoredObject;
...
public interface IWebdavStore {
	 ...
	 *            character encoding of the resource or <code>null</code> if unknown or not applicable
	 ...
	 * @param resourceUri
	 *            URI of the content resource
	 * @return length of the resource in bytes, <code>-1</code> declares this value as invalid and asks the adapter to try to set it from the properties if possible
	 * @throws WebdavException
	 *             if something goes wrong on the store level
	 */
