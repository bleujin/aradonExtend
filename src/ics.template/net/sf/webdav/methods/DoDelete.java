...
public class DoDelete extends AbstractMethod {
	...
	private static Logger LOG = LogBroker.getLogger(DoDelete.class);
	 ...
	 */
	public void deleteResource(ITransaction transaction, String path, Hashtable<String, Integer> errorList, InnerRequest req, InnerResponse resp) throws IOException, WebdavException {
	 ...
	 *             if an error in the underlying store occurs
	 */
	private void deleteFolder(ITransaction transaction, String path, Hashtable<String, Integer> errorList, InnerRequest req, InnerResponse resp) throws WebdavException {
